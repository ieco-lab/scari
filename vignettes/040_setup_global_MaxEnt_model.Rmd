...
model_info_kable <- knitr::kable(x = model_info) |>
  ...
  kableExtra::add_header_above(header = c("Global-scale model (version 5)" = 4))
...
# save as csv
write_csv(x = global_points, file = file.path(here::here(), "vignette-outputs", "data-tables", "global_background_points_v5.csv"))
# save as rds file
write_rds(global_points, file = file.path(here::here(), "data", "global_background_points_v5.rds"))
...
# points
global_points <- read_csv(file = file.path(here::here(), "vignette-outputs", "data-tables", "global_background_points_v5.csv"))
...
ggplot2::ggsave(
  global_background_plot, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "global_model_background_points_v5.jpg"),
  height = 8, 
  width = 12,
  device = jpeg,
  dpi = 500
...
ggsave(
  global_slf_plot, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "global_model_presence_points_v5.jpg"),
  height = 8, 
  width = 12,
  device = jpeg,
  dpi = 500
...
ggsave(
  global_patchwork, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "global_model_v5_summary.jpg"),
  height = 8, 
  width = 10,
  device = jpeg,
  dpi = "retina"
