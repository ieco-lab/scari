...
```{r set wd, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r load model objects- regional ensemble, eval = TRUE, warning = FALSE, message = FALSE}
...
This vignette contains 3 main types of code chunks, which can be discerned by the title: 

1. **Extract ___ plots per model**: This type of chunk extracts different types of response curves per model and environmental variable.
2. **Maximum Activity**: This type of chunk extracts the value of the maximum activity of the model along the curve for plotting
3. **Combine Plots**: This type of chunk combines the plots of the models response curves, per environmental variable and separately for the regional-scale and global-scale models.
...
regional_invaded_n_american_marginal_bio11 <- SDMtune::plotResponse(
...
bio11_max_activity_values <- c(
  ...
  invaded_n_american_bio_11 = regional_invaded_n_american_marginal_bio11$data[[1]][which.max(regional_invaded_n_american_marginal_bio11$data[[1]]$y), ]$x,
...
bio11_marginal_combined <- ggplot() +
  ...
  geom_smooth(data = regional_invaded_n_american_marginal_bio11$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica"), se = FALSE, method = "gam") +
  ...
  # invaded_n_american
  geom_rug(aes(x = regional_invaded_n_american_marginal_bio11$data[[2]]$x, color = "Ri.NAmerica"), sides = "t", alpha = 0.8) +
  # Ri.Asia
...
```{r save plot- bio 11 marginal, include = FALSE}
...
regional_invaded_n_american_marginal_bio12 <- SDMtune::plotResponse(
  model = regional_invaded_n_american_model,
  var = "bio12",
  type = "cloglog",
  fun = mean,
...
bio12_max_activity_values <- c(
  ...
  invaded_n_american_bio_12 = regional_invaded_n_american_marginal_bio12$data[[1]][which.max(regional_invaded_n_american_marginal_bio12$data[[1]]$y), ]$x,
...
bio12_marginal_combined <- ggplot() +
  ...
  # invaded_n_american model data
  geom_smooth(data = regional_invaded_n_american_marginal_bio12$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica"), se = FALSE, method = "gam") +
  # Ri.Asia model data
  ...
  # invaded_n_american
  geom_rug(aes(x = regional_invaded_n_american_marginal_bio12$data[[2]]$x, color = "Ri.NAmerica"), sides = "t", alpha = 0.8) +
  # Ri.Asia
...
```{r save plot- bio 12 marginal, include = FALSE}
...
regional_invaded_n_american_marginal_bio15 <- SDMtune::plotResponse(
  model = regional_invaded_n_american_model,
  var = "bio15",
  type = "cloglog",
  fun = mean,
...
bio15_max_activity_values <- c(
  ...
  invaded_n_american_bio_15 = regional_invaded_n_american_marginal_bio15$data[[1]][which.max(regional_invaded_n_american_marginal_bio15$data[[1]]$y), ]$x,
...
bio15_marginal_combined <- ggplot() +
  ...
  # invaded_n_american model data
  geom_smooth(data = regional_invaded_n_american_marginal_bio15$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica"), se = FALSE, method = "gam") +
  # invaded_asian model data
  ...
  # invaded_n_american
  geom_rug(aes(x = regional_invaded_n_american_marginal_bio15$data[[2]]$x, color = "Ri.NAmerica"), sides = "t", alpha = 0.8) +
  # Ri.Asia
...
```{r save plot- bio 15 marginal, include = FALSE}
...
regional_invaded_n_american_marginal_bio2 <- SDMtune::plotResponse(
  model = regional_invaded_n_american_model,
  var = "bio2",
  type = "cloglog",
  fun = mean,
...
bio2_max_activity_values <- c(
  ...
  invaded_n_american_bio_2 = regional_invaded_n_american_marginal_bio2$data[[1]][which.max(regional_invaded_n_american_marginal_bio2$data[[1]]$y), ]$x,
...
bio2_marginal_combined <- ggplot() +
  ...
  # invaded_n_american model data
  geom_smooth(data = regional_invaded_n_american_marginal_bio2$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica"), se = FALSE, method = "gam") +
  # invaded_asian model data
  ...
  # invaded_n_american
  geom_rug(aes(x = regional_invaded_n_american_marginal_bio2$data[[2]]$x, color = "Ri.NAmerica"), sides = "t", alpha = 0.8) +
  # Ri.Asia
...
```{r save plot- bio 2 marginal, include = FALSE}
...
```{r scatter style object- univar, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r extract univar plots per model- bio 11 univar, eval = TRUE, warning = FALSE, message = FALSE}
...
regional_invaded_n_american_univar_bio11 <- SDMtune::plotResponse(
  model = regional_invaded_n_american_model,
  var = "bio11",
  type = "cloglog",
  fun = mean,
...
```{r maximum activity- bio 11 univar, eval = TRUE, warning = FALSE, message = FALSE}
...
bio11_univar_max_activity_values <- c(
  ...
  invaded_n_american_bio11 = regional_invaded_n_american_univar_bio11$data[[1]][which.max(regional_invaded_n_american_univar_bio11$data[[1]]$y), ]$x,
  invaded_asian_bio11 = regional_invaded_asian_univar_bio11$data[[1]][which.max(regional_invaded_asian_univar_bio11$data[[1]]$y), ]$x
)

```

```{r combine plots- bio 11 univar, eval = TRUE, warning = FALSE, message = FALSE}
...
bio11_univar_combined <- ggplot() +
  ...
  # invaded_n_american model data
  geom_smooth(data = regional_invaded_n_american_univar_bio11$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica"), se = FALSE, method = "gam") +
  # Ri.Asia model data
  ...
  # invaded_n_american
  geom_rug(aes(x = regional_invaded_n_american_univar_bio11$data[[2]]$x, color = "Ri.NAmerica"), sides = "t", alpha = 0.8) +
  # Ri.Asia
...
```{r save plot- bio 11 univar, include = FALSE}
...
```{r extract univar plots per model- bio 12, eval = TRUE, warning = FALSE, message = FALSE}
...
regional_invaded_n_american_univar_bio12 <- SDMtune::plotResponse(
  model = regional_invaded_n_american_model,
  var = "bio12",
  type = "cloglog",
  fun = mean,
...
```{r maximum activity- bio 12 univar, eval = TRUE, warning = FALSE, message = FALSE}
...
bio12_univar_max_activity_values <- c(
  ...
  invaded_n_american_bio12 = regional_invaded_n_american_univar_bio12$data[[1]][which.max(regional_invaded_n_american_univar_bio12$data[[1]]$y), ]$x,
  invaded_asian_bio12 = regional_invaded_asian_univar_bio12$data[[1]][which.max(regional_invaded_asian_univar_bio12$data[[1]]$y), ]$x
)

```

```{r combine plots- bio 12 univar, eval = TRUE, warning = FALSE, message = FALSE}
...
bio12_univar_combined <- ggplot() +
  ...
  # invaded_n_american model data
  geom_smooth(data = regional_invaded_n_american_univar_bio12$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica"), se = FALSE, method = "gam") +
  # invaded_asian model data
  ...
  # invaded_n_american
  geom_rug(aes(x = regional_invaded_n_american_univar_bio12$data[[2]]$x, color = "Ri.NAmerica"), sides = "t", alpha = 0.8) +
  # Ri.Asia
...
```{r save plot- bio 12 univar, include = FALSE}
...
```{r extract univar plots per model- bio 15, eval = TRUE, warning = FALSE, message = FALSE}
...
regional_invaded_n_american_univar_bio15 <- SDMtune::plotResponse(
  model = regional_invaded_n_american_model,
  var = "bio15",
  type = "cloglog",
  fun = mean,
...
```{r maximum activity- bio 15 univar, eval = TRUE, warning = FALSE, message = FALSE}
...
bio15_univar_max_activity_values <- c(
  ...
  invaded_n_american_bio15 = regional_invaded_n_american_univar_bio15$data[[1]][which.max(regional_invaded_n_american_univar_bio15$data[[1]]$y), ]$x,
  invaded_asian_bio15 = regional_invaded_asian_univar_bio15$data[[1]][which.max(regional_invaded_asian_univar_bio15$data[[1]]$y), ]$x
)

```

```{r combine plots- bio 15 univar, eval = TRUE, warning = FALSE, message = FALSE}
...
bio15_univar_combined <- ggplot() +
  ...
  # invaded_n_american model data
  geom_smooth(data = regional_invaded_n_american_univar_bio15$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica"), se = FALSE, method = "gam") +
  # invaded_asian model data
  ...
  # invaded_n_american
  geom_rug(aes(x = regional_invaded_n_american_univar_bio15$data[[2]]$x, color = "Ri.NAmerica"), sides = "t", alpha = 0.8) +
  # Ri.Asia
...
```{r save plot- bio 15 univar, include = FALSE}
...
```{r extract univar plots per model- bio 2, eval = TRUE, warning = FALSE, message = FALSE}
...
regional_invaded_n_american_univar_bio2 <- SDMtune::plotResponse(
  model = regional_invaded_n_american_model,
  var = "bio2",
  type = "cloglog",
  fun = mean,
...
```{r maximum activity- bio 2 univar, eval = TRUE, warning = FALSE, message = FALSE}
...
bio2_univar_max_activity_values <- c(
  ...
  invaded_n_american_bio2 = regional_invaded_n_american_univar_bio2$data[[1]][which.max(regional_invaded_n_american_univar_bio2$data[[1]]$y), ]$x,
  invaded_asian_bio2 = regional_invaded_asian_univar_bio2$data[[1]][which.max(regional_invaded_asian_univar_bio2$data[[1]]$y), ]$x
)

```

```{r combine plots- bio 2 univar, eval = TRUE, warning = FALSE, message = FALSE}
...
bio2_univar_combined <- ggplot() +
  ...
  # invaded_n_american model data
  geom_smooth(data = regional_invaded_n_american_univar_bio2$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica"), se = FALSE, method = "gam") +
  # Ri.Asia model data
  ...
  # invaded_n_american
  geom_rug(aes(x = regional_invaded_n_american_univar_bio2$data[[2]]$x, color = "Ri.NAmerica"), sides = "t", alpha = 0.8) +
  # Ri.Asia
...
```{r save plot- bio 2 univar, include = FALSE}
...
```{r univar plot style object, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r load model objects- global, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r save plot- global bio11 marginal, include = FALSE}
...
```{r extract univariate plots for global model, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r maximum activity- global univar, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r save plot- global bio 11 univar, include = FALSE}
...
```{r bio12 plot- global univar, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r save plot- global bio 12 univar, include = FALSE}
...
```{r bio15 plot- global univar, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r save plot- global bio 15 univar, include = FALSE}
...
```{r bio2 plot- global univar, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r save plot- global bio 2 univar, include = FALSE}
...
```{r combine plots- bio 11 univar combined unsmoothed}

bio11_univar_combined_uns <- ggplot() +
  # global
  geom_line(data = global_univar_bio11$data[[1]], aes(x = x, y = y, color = "global")) +
  # Rn (native) model data
  geom_line(data = regional_native_univar_bio11$data[[1]], aes(x = x, y = y, color = "Rn (native)")) +
  # invaded_n_american model data
  geom_line(data = regional_invaded_n_american_univar_bio11$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica")) +
  # Ri.Asia model data
  geom_line(data = regional_invaded_asian_univar_bio11$data[[1]], aes(x = x, y = y, color = "Ri.Asia")) +
  # plot peak trendline and labels
  # global
   geom_vline(aes(xintercept = bio11_univar_max_activity_global, color = "global"), linetype = "dashed", linewidth = 0.5) +
  # Rn (native)
...
```{r combine plots- bio 12 univar combined unsmoothed}

bio12_univar_combined_uns <- ggplot() +
  # global
  ...
  # invaded_n_american model data
  geom_line(data = regional_invaded_n_american_univar_bio12$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica")) +
  # Ri.Asia model data
...
```{r combine plots- bio 15 univar combined unsmoothed}

bio15_univar_combined_uns <- ggplot() +
  # global
  ...
  # invaded_n_american model data
  geom_line(data = regional_invaded_n_american_univar_bio15$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica")) +
  # Ri.Asia model data
...
```{r combine plots- bio 2 univar combined unsmoothed}

bio2_univar_combined_uns <- ggplot() +
  # global
  ...
  # invaded_n_american model data
  geom_line(data = regional_invaded_n_american_univar_bio2$data[[1]], aes(x = x, y = y, color = "Ri.NAmerica")) +
  # Ri.Asia model data
...
## univariate resp curves unsmoothed

```{r univariate unsmoothed}

bio2_univar_combined_uns  <- bio2_univar_combined_uns +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
bio11_univar_combined_uns <- bio11_univar_combined_uns + 
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
bio12_univar_combined_uns <- bio12_univar_combined_uns + 
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
bio15_univar_combined_uns <- bio15_univar_combined_uns + 
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
univar_combined_uns_patchwork <- (bio2_univar_combined_uns + bio11_univar_combined_uns + bio12_univar_combined_uns + bio15_univar_combined_uns) +
  plot_annotation(title = "Univariate response of 'regional_ensemble' and 'global' models") +
  plot_layout(axes = "collect_y", axis_titles = "collect_y", guides = "collect") & # collect y axis and legends
  theme(legend.position = "bottom") 
...
```{r save plot- univar patchwork entire unsmoothed}

ggsave(
  univar_combined_uns_patchwork, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "regional_ensemble_global_combined_univar_resp_curve_cloglog_unsmoothed.jpg"),
  height = 8, 
  width = 10,
  device = jpeg,
  dpi = "retina"
...
```{r patchwork in halves- pt 1 unsmoothed}

univar_combined_uns_patchwork_pt1 <- (bio2_univar_combined_uns + bio11_univar_combined_uns) +
  plot_annotation(title = "Univariate response of 'regional_ensemble' and 'global' models- Raw outputs") +
  plot_layout(axes = "collect_y", axis_titles = "collect_y", guides = "collect", nrow = 2) & # collect y axis and legends
  theme(legend.position = "bottom") 

# save
ggsave(
  univar_combined_uns_patchwork_pt1, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "regional_ensemble_global_combined_univar_resp_curve_cloglog_half1_unsmoothed.jpg"),
  height = 8, 
  width = 10,
  device = jpeg,
  dpi = "retina"
...
```{r patchwork in halves- pt 2 unsmoothed}

univar_combined_uns_patchwork_pt2 <- (bio12_univar_combined_uns + bio15_univar_combined_uns) +
  plot_annotation(title = "Univariate response of 'regional_ensemble' and 'global' models- Raw outputs") +
  plot_layout(axes = "collect_y", axis_titles = "collect_y", guides = "collect", nrow = 2) & # collect y axis and legends
  theme(legend.position = "bottom") 
...
# save
ggsave(
  univar_combined_uns_patchwork_pt2, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "regional_ensemble_global_combined_univar_resp_curve_cloglog_half2_unsmoothed.jpg"),
  height = 8, 
  width = 10,
  device = jpeg,
  dpi = "retina"
