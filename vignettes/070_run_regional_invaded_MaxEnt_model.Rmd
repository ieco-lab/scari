...
# background points
a_regional_invaded_background_points <- read.csv(file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_background_points_v9.csv"))
...
p_slf_invaded_train <- read.csv(file = file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_train_slf_presences_v9.csv"))
...
SDMtune::swd2csv(swd = regional_invaded_train, file_name = c(
  file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_train_slf_presences_with_data_v9.csv"),
  file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_background_points_with_data_v9.csv")
  ))
...
p_slf_invaded_test <- read.csv(file = file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_test_slf_presences_v9.csv"))
...
SDMtune::swd2csv(swd = regional_invaded_test, file_name = c(
  file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_test_slf_presences_with_data_v9.csv"),
...
mypath <- file.path(here::here() %>% 
                       dirname(),
                     "maxent/models/slf_regional_invaded_v9")
...
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_jackknife_training.jpg"),
...
# training
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_jackknife_testing.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
# bio 2
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_bio2_univar_resp_curve_cloglog.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
# bio 11
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_bio11_univar_resp_curve_cloglog.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
# bio 12
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_bio12_univar_resp_curve_cloglog.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
# bio 15
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_bio15_univar_resp_curve_cloglog.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
The model itself had a training AUC of 0.976 and a test AUC of 0.455. The test AUC is less than desired (at least 0.5), but we will be averaging this model with the other two regional models downstream. 
...
# ROC
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_ROC.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
# historical data
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_pred_suit_clamped_cloglog_thresholded_MTSS_fixed_1_globe_1981-2010.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_pred_suit_clamped_cloglog_thresholded_MTSS_fixed_1_globe_2041-2070_GFDL_ssp126.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
# ssp126 for 2041-2070 data
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_pred_suit_clamped_cloglog_thresholded_MTSS_fixed_1_globe_2041-2070_GFDL_ssp370.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
# ssp126 for 2041-2070 data
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_invaded_pred_suit_clamped_cloglog_thresholded_MTSS_fixed_1_globe_2041-2070_GFDL_ssp585.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
