...
spain_future <- spain_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  xlim(-964862.802508965, 482431.4012544825) +
  ylim(4198673.820940024, 5088510.34806054)
...
canary_future <- spain_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  xlim(-1833239.3247670338, -1254321.6432616548) +
  ylim(3321459.358225577, 3658789.3248550068) +
  labs(subtitle = "Spain: canary islands")
...
portugal_future <- portugal_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  xlim(-1100000, -600000) +
  ylim(4400000, 4900750.206464033)
...
south_africa_future <- south_africa_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  xlim(1447294.2037634475, 3377019.808781378) +
  ylim(-4198673.820940021, -2739869.8684837967)
...
new_zealand_future <- new_zealand_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  xlim(15920236.241397923, 17367530.445161372) +
  ylim(-5445383.869156103, -4093085.6280890987)
...
australia_future <- australia_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  xlim(10613490.827598616, 14955373.438888958) +
  ylim(5088510.348060536, 1269436.7435378374)
...
russia_future <- russia_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  xlim(3029725.60501793, 17367530.445161372) +
  ylim(4000000, 8000000) 
...
chile_future <- chile_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  xlim(-7525929.859569928, -6271608.216308273) 
...
romania_risk_map <- romania_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
USA_risk_map <- united_states_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# australia
australia_risk_map <- australia_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# tasmania
tasmania_risk_map <- tasmania_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
argentina_risk_map <- argentina_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# france
france_risk_map <- france_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
...
# germany map
germany_risk_map <- germany_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
...
# italy map
italy_risk_map <- italy_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# edit maps
# hungary
austria_risk_map <- austria_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# hungary
hungary_risk_map <- hungary_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# czechia map
czechia_risk_map <- czechia_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# greece map
greece_risk_map <- greece_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# algeria
algeria_risk_map <- algeria_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# edit maps
# canada
canada_risk_map <- canada_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# mexico
mexico_risk_map <- mexico_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# edit maps
# türkiye
türkiye_risk_map <- türkiye_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# georgia
georgia_risk_map <- georgia_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
japan_risk_plot <- ggplot_gtable(japan_risk_plot) %>%
  ...
  # edit maps
# new zealand
china_risk_map <- china_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# south_korea
south_korea_risk_map <- south_korea_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
# japan
japan_risk_map <- japan_slf_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
