...
The model itself had a training AUC of 0.91 and a test AUC of 0.988. The test AUC is higher than the training AUC, but this is not surprising, as the test points within the invaded range are much more geographically constrained than within the native range.
