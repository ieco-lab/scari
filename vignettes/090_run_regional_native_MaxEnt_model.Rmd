...
The suitability maps for this model are shown below. I will load in the maps that were thresholded by both the MTSS and MTP thresholds. Bear in mind that I chose the MTSS threshold for analyses downstream. Here are the maps for:
...
# historical data
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_native_pred_suit_clamped_cloglog_thresholded_MTSS_MTP_globe_1981-2010.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_native_pred_suit_clamped_cloglog_thresholded_MTSS_MTP_globe_2041-2070_GFDL_ssp126.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
# ssp126 for 2041-2070 data
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_native_pred_suit_clamped_cloglog_thresholded_MTSS_MTP_globe_2041-2070_GFDL_ssp370.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
...
# ssp126 for 2041-2070 data
knitr::include_graphics(
  path = file.path(mypath, "plots", "regional_native_pred_suit_clamped_cloglog_thresholded_MTSS_MTP_globe_2041-2070_GFDL_ssp585.jpg"),
  rel_path = FALSE, # already done
  error = TRUE
  )
