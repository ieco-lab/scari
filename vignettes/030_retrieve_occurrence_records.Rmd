...
if (FALSE) {
  ...
  slf_lyde_raw <- readr::read_csv(file = file.path(here::here(), "data-raw", "slf_lyde_raw_coords_2026-06-23.csv"))
  
  # overwrite save original version
  write_csv(x = slf_lyde_raw, file = file.path(here::here(), "data-raw", "slf_lyde_raw_coords_2026-06-23.csv"))
...
# read in data
slf_lyde <- readr::read_csv(file = file.path(here::here(), "data-raw", "slf_lyde_raw_coords_2026-06-23.csv"))
...
write_csv(slf_lyde2, file = file.path(here::here(), "vignette-outputs", "data-tables", "slf_lyde_cleaned_coords_2026-06-23.csv"))

# also save as a .rds file
write_rds(slf_lyde2, file = file.path(here::here(), "data", "slf_lyde_cleaned_coords_2026-06-23.rds"))
...
# raw data
lyde_raw <- readr::read_csv(file = file.path(here::here(), "data-raw", "slf_lyde_raw_coords_2026-06-23.csv"))
...
slf_lyde3 <- readr::read_csv(file.path(here::here(), "vignette-outputs", "data-tables", "slf_lyde_cleaned_coords_2026-06-23.csv"))
...
write_csv(x = slf_all_coords, file = file.path(here::here(), "vignette-outputs", "data-tables", "slf_all_coords_2026-06-23.csv"))
...
This thinning method left 3261 of 4623 records.
...
This thinning method removed an additional ~80 records, reducing the final number to 3189. 
...
This method removed a lot of coordinates- reducing the final count from 3020 to 1891 records.
...
write_csv(x = slf_all_coords3, file = file.path(here::here(), "vignette-outputs", "data-tables", paste0("slf_all_coords_final_2026-06-23_epsg4326.csv")))
...
# save
write_csv(x = slf_all_coords5, file = file.path(here::here(), "vignette-outputs", "data-tables", paste0("slf_all_coords_final_2026-06-23.csv")))

# also save as a .rds file
write_rds(slf_all_coords5, file = file.path(here::here(), "data", paste0("slf_all_coords_final_2026-06-23.rds")))
  
```

```{r map all points, eval = TRUE}

slf_all_coords_df <- readr::read_csv(file = file.path(here::here(), "vignette-outputs", "data-tables", "slf_all_coords_final_2026-06-23_epsg4326.csv"))
