...
```{r deduplicate wineries, eval = TRUE}
...
```{r convert to new projection, eval = TRUE}
...
```{r save plot and dataset- IVR regions}
...
```{r map of data from published sources Asia, eval = TRUE, message = FALSE, warning = FALSE}
...
```{r map of data from published sources NAmerica, eval = TRUE, message = FALSE, warning = FALSE}
