...
# intersect
regional_invaded_withSLF <- sf::st_filter(x = KG_zones_invaded_poly, y = slf_points_invaded, join = sf::st_contains)
...
write_csv(
  ...
  file = file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_background_points_v9.csv")
  )
# save as rds file
write_rds(
  regional_invaded_background, 
  file = file.path(here::here(), "data", "regional_invaded_background_points_v9.rds")
)
...
regional_invaded_background <- read.csv(file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_background_points_v9.csv")) 
...
ggsave(
  regional_invaded_background_plot, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "regional_invaded_model_background_points_v9.jpg"),
  height = 8, 
  width = 10,
  device = jpeg,
  dpi = 500
...
write_csv(
  ...
  file = file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_train_slf_presences_v9.csv")
)
...
slf_points_invaded <- read_csv(file = file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_train_slf_presences_v9.csv")) 
...
ggsave(
  regional_invaded_slf_plot, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "regional_invaded_train_slf_presences_v9.jpg"),
  height = 8, 
  width = 10,
  device = jpeg,
  dpi = 500
...
# select 20% of training total using round(nrow(slf_points_invaded) * 0.2) 
...
# slf_points_invaded_test_rows <-  sample(nrow(slf_points_invaded_asian), size = round(nrow(slf_points_invaded) * 0.2), replace = FALSE) 
# filter
...
slf_points_invaded_test <- slf_points_invaded_asian

# write to csv
write_csv(
  x = slf_points_invaded_test,
  file = file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_test_slf_presences_v9.csv")
)
...
slf_points_invaded_asian_test_rows <-  sample(nrow(slf_points_invaded), size = round(nrow(slf_points_invaded_asian) * 0.2), replace = FALSE)
# filter
...
# randomly select subset of rows for testing, without replacement
slf_points_native_test_rows <-  sample(nrow(slf_points_invaded), size = round(nrow(slf_points_native) * 0.2), replace = FALSE) 
# filter
...
ggsave(
  regional_invaded_patchwork, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "regional_invaded_model_v9_summary.jpg"),
  height = 10, 
  width = 14,
  device = jpeg,
  dpi = 500
