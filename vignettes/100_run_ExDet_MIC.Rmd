...
exdet_regional_invaded_n_american_hist_plot <- map_exdet(
  ...
  raster.df = exdet_MIC_regional_invaded_n_american_hist[["data"]][["all"]]
)
...
# plot mean raster first
exdet_MIC_regional_invaded_n_american_126_plot <- map_exdet(
  raster = exdet_regional_invaded_n_american_126,
  raster.df = exdet_MIC_regional_invaded_n_american_126[["data"]][["all"]]
)

exdet_MIC_regional_invaded_n_american_126_plot <- exdet_MIC_regional_invaded_n_american_126_plot +
  ggnewscale::new_scale_fill() +
  # add layer for bg point area
  geom_raster(data = regional_invaded_n_american_background_area_df, aes(x = x, y = y, fill = "Background")) +
  # scale 2
...
ggsave(
  exdet_MIC_regional_invaded_n_american_126_plot, 
...
# plot mean raster first
exdet_MIC_regional_invaded_n_american_370_plot <- map_exdet(
  raster = exdet_regional_invaded_n_american_370,
  raster.df = exdet_MIC_regional_invaded_n_american_370[["data"]][["all"]]
)

exdet_MIC_regional_invaded_n_american_370_plot <- exdet_MIC_regional_invaded_n_american_370_plot +
  # new scale
  ggnewscale::new_scale_fill() +
  # add layer for bg point area
  geom_raster(data = regional_invaded_n_american_background_area_df, aes(x = x, y = y, fill = "Background")) +
...
ggsave(
  exdet_MIC_regional_invaded_n_american_370_plot, 
...
# plot mean raster first
exdet_MIC_regional_invaded_n_american_585_plot <- map_exdet(
  raster = exdet_regional_invaded_n_american_585,
  raster.df = exdet_MIC_regional_invaded_n_american_585[["data"]][["all"]]
)

exdet_MIC_regional_invaded_n_american_585_plot <- exdet_MIC_regional_invaded_n_american_585_plot +
  # new scale
  ggnewscale::new_scale_fill() +
  # add layer for bg point area
  geom_raster(data = regional_invaded_n_american_background_area_df, aes(x = x, y = y, fill = "Background")) +
...
ggsave(
  exdet_MIC_regional_invaded_n_american_585_plot, 
