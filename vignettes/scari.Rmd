...
scari::create_MaxEnt_suitability_maps(
  ...
  thresh = c("MTP", "10_percentile", "MTSS"), # the thresholds used to create thresholded maps, as desired
  map.thresh.extra = "MTP", # put an extra threshold under the main threshold in thresh
