...
regional_ensemble_thresholds <- read_csv(file = file.path(mypath, "slf_regional_ensemble_v2", "ensemble_threshold_values.csv"))
...
global_1995 <- terra::rast(
  x = file.path(mypath, "slf_global_v4", "global_pred_suit_clamped_cloglog_globe_1981-2010_mean.asc")
  )

# CMIP6
# ssp126
global_2055_126 <- terra::rast(
  x = file.path(mypath, "slf_global_v4", "global_pred_suit_clamped_cloglog_globe_2041-2070_GFDL_ssp126_mean.asc")
  )
# ssp370
global_2055_370 <- terra::rast(
  x = file.path(mypath, "slf_global_v4", "global_pred_suit_clamped_cloglog_globe_2041-2070_GFDL_ssp370_mean.asc")
  )
# ssp126
global_2055_585 <- terra::rast(
  x = file.path(mypath, "slf_global_v4", "global_pred_suit_clamped_cloglog_globe_2041-2070_GFDL_ssp585_mean.asc")
  )

# also import mean raster
global_2055_ssp_mean <- terra::rast(
  x = file.path(mypath, "slf_global_v4", "global_pred_suit_clamped_cloglog_globe_2041-2070_GFDL_ssp_averaged.asc")
  )
...
summary_global <- read_csv(file.path(mypath, "slf_global_v4", "global_summary_all_iterations.csv")) %>%
...
ggsave(
  regional_ensemble_1995_plot,
  filename = file.path(mypath, "slf_regional_ensemble_v2", "plots", "regional_ensemble_pred_suit_globe_1981-2010.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
ggsave(
  global_1995_plot,
  filename = file.path(mypath, "slf_global_v4", "plots", "global_pred_suit_globe_1981-2010.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
ggsave(
  ...
  filename = file.path(mypath, "slf_regional_ensemble_v2", "plots", "regional_ensemble_pred_suit_globe_2041-2070_GFDL_ssp126.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
ggsave(
  ...
  filename = file.path(mypath, "slf_global_v4", "plots", "global_pred_suit_globe_2041-2070_GFDL_ssp126.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
ggsave(
  ...
  filename = file.path(mypath, "slf_regional_ensemble_v2", "plots", "regional_ensemble_pred_suit_globe_2041-2070_GFDL_ssp370.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
ggsave(
  ...
  filename = file.path(mypath, "slf_global_v4", "plots", "global_pred_suit_globe_2041-2070_GFDL_ssp370.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
ggsave(
  ...
  filename = file.path(mypath, "slf_regional_ensemble_v2", "plots", "regional_ensemble_pred_suit_globe_2041-2070_GFDL_ssp585.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
ggsave(
  ...
  filename = file.path(mypath, "slf_global_v4", "plots", "global_pred_suit_globe_2041-2070_GFDL_ssp585.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
ggsave(
  regional_ensemble_2055_ssp_mean_plot,
  filename = file.path(mypath, "slf_regional_ensemble_v2", "plots", "regional_ensemble_pred_suit_globe_2041-2070_GFDL_ssp_mean.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
ggsave(
  global_2055_ssp_mean_plot,
  filename = file.path(mypath, "slf_global_v4", "plots", "global_pred_suit_globe_2041-2070_GFDL_ssp_mean.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
regional_ensemble_1995_classified <- terra::classify(
  ...
  filename = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_1981-2010.asc"), # also write to file
  filetype = "AAIGrid",
  overwrite = FALSE
  ) 
...
global_1995_classified <- terra::classify(
  ...
  filename = file.path(mypath, "working_dir", "slf_global_v4_binarized_1981-2010.asc"), 
  filetype = "AAIGrid",
  overwrite = FALSE
  ) 
...
regional_ensemble_1995_classified_df <- terra::rast(
  x = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_1981-2010.asc")
  ) %>%
...
regional_ensemble_2055_126_classified <- terra::classify(
  ...
  right = NA, # close both ends of the range of classification values
  others = strtoi(00000001, base = 2), # make it the unsuitable value if not in this range
  filename = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp126_GFDL.asc"), # also write to file
  filetype = "AAIGrid",
  overwrite = FALSE
  ) 
...
global_2055_126_classified <- terra::classify(
  ...
  right = NA, 
  others = strtoi(00000100, base = 2), 
  filename = file.path(mypath, "working_dir", "slf_global_v4_binarized_2041-2070_ssp126_GFDL.asc"), 
  filetype = "AAIGrid",
  overwrite = FALSE
  ) 
...
regional_ensemble_2055_126_classified_df <- terra::rast(
  x = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp126_GFDL.asc")
  ) %>%
  terra::as.data.frame(., xy = TRUE)
...
regional_ensemble_2055_370_classified <- terra::classify(
  ...
  right = NA, # close both ends of the range of classification values
  others = strtoi(00000001, base = 2), # make it the unsuitable value if not in this range
  filename = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp370_GFDL.asc"), # also write to file
  filetype = "AAIGrid",
  overwrite = FALSE
  ) 
...
global_2055_370_classified <- terra::classify(
  ...
  right = NA, 
  others = strtoi(00000100, base = 2), 
  filename = file.path(mypath, "working_dir", "slf_global_v4_binarized_2041-2070_ssp370_GFDL.asc"), 
  filetype = "AAIGrid",
  overwrite = FALSE
  ) 
...
regional_ensemble_2055_370_classified_df <- terra::rast(
  x = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp370_GFDL.asc")
  ) %>%
  terra::as.data.frame(., xy = TRUE)
...
regional_ensemble_2055_585_classified <- terra::classify(
  ...
  right = NA, # close both ends of the range of classification values
  others = strtoi(00000001, base = 2), # make it the unsuitable value if not in this range
  filename = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp585_GFDL.asc"), # also write to file
  filetype = "AAIGrid",
  overwrite = FALSE
  ) 
...
global_2055_585_classified <- terra::classify(
  ...
  right = NA, 
  others = strtoi(00000100, base = 2), 
  filename = file.path(mypath, "working_dir", "slf_global_v4_binarized_2041-2070_ssp585_GFDL.asc"), 
  filetype = "AAIGrid",
  overwrite = FALSE
  ) 
...
regional_ensemble_2055_585_classified_df <- terra::rast(
  x = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp585_GFDL.asc")
  ) %>%
  terra::as.data.frame(., xy = TRUE)
...
regional_ensemble_2055_ssp_mean_classified <- terra::classify(
  ...
  right = NA, # close both ends of the range of classification values
  others = strtoi(00000001, base = 2), # make it the unsuitable value if not in this range
  filename = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp_mean_GFDL.asc"), # also write to file
  filetype = "AAIGrid",
  overwrite = FALSE
  ) 
...
global_2055_ssp_mean_classified <- terra::classify(
  ...
  right = NA, 
  others = strtoi(00000100, base = 2), 
  filename = file.path(mypath, "working_dir", "slf_global_v4_binarized_2041-2070_ssp_mean_GFDL.asc"), 
  filetype = "AAIGrid",
  overwrite = FALSE
  ) 
...
regional_ensemble_2055_ssp_mean_classified_df <- terra::rast(
  x = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp_mean_GFDL.asc")
  ) %>%
  terra::as.data.frame(., xy = TRUE)
...
global_1995_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_global_v4_binarized_1981-2010.asc"))

regional_ensemble_1995_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_1981-2010.asc"))
...
global_2055_126_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_global_v4_binarized_2041-2070_ssp126_GFDL.asc"))

regional_ensemble_2055_126_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp126_GFDL.asc"))
...
global_2055_370_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_global_v4_binarized_2041-2070_ssp370_GFDL.asc"))

regional_ensemble_2055_370_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp370_GFDL.asc"))
...
global_2055_585_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_global_v4_binarized_2041-2070_ssp585_GFDL.asc"))

regional_ensemble_2055_585_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp585_GFDL.asc"))
...
global_2055_ssp_mean_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_global_v4_binarized_2041-2070_ssp_mean_GFDL.asc"))

regional_ensemble_2055_ssp_mean_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_regional_ensemble_v2_binarized_2041-2070_ssp_mean_GFDL.asc"))
...
# NOTE this throws GDAL error 2050 "reprojection failed"- I read this means that some points are outside of projection domain- this happened initially when I projected the original rasters to ESRI:54017, so I am guessing this is related to that issue
...
table.df.output[2, 1] <- kableExtra::cell_spec(table.df.output[2, 1], format = "html", background = "darkblue")
