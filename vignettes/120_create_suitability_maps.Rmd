...
regional_ensemble_thresholds <- read_csv(file = file.path(mypath, "slf_regional_ensemble_v3", "ensemble_threshold_values.csv"))
...
global_1995 <- terra::rast(
  x = file.path(mypath, "slf_global_v5", "global_pred_suit_clamped_cloglog_globe_1981-2010_mean.asc")
  )

# CMIP6
# ssp126
global_2055_126 <- terra::rast(
  x = file.path(mypath, "slf_global_v5", "global_pred_suit_clamped_cloglog_globe_2041-2070_GFDL_ssp126_mean.asc")
  )
# ssp370
global_2055_370 <- terra::rast(
  x = file.path(mypath, "slf_global_v5", "global_pred_suit_clamped_cloglog_globe_2041-2070_GFDL_ssp370_mean.asc")
  )
# ssp126
global_2055_585 <- terra::rast(
  x = file.path(mypath, "slf_global_v5", "global_pred_suit_clamped_cloglog_globe_2041-2070_GFDL_ssp585_mean.asc")
  )

# also import mean raster
global_2055_ssp_mean <- terra::rast(
  x = file.path(mypath, "slf_global_v5", "global_pred_suit_clamped_cloglog_globe_2041-2070_GFDL_ssp_averaged.asc")
  )
...
summary_global <- read_csv(file.path(mypath, "slf_global_v5", "global_summary_all_iterations.csv")) %>%
...
map_cloglog_output <- function(raster.df, raster.value.name, thresh.fixed_1, thresh.MTSS) {
  
  # raster.df = the dataframe of the raster
  # raster.value.name = the name of the raster values
  # thresh.fixed_1 = the df cell coordinates of the fixed_1 thresh
  ...
  ggplot() +
    ...
    scale_fill_gradientn(
      # the values of the color divisions: 0, fixed_1, slightly above fixed_1, MTSS, slightly above MTSS, 0.5, 0.75, 1
      values = c(
        0, # minimum
        as.numeric(thresh.fixed_1), # fixed_1 thresh
        as.numeric(thresh.fixed_1) + 0.0000001, # some small amount more than the fixed_1
      ...
      # the colors for the divisions in the order: 0, fixed_1, slightly above fixed_1, MTSS, slightly above MTSS, 0.5, 0.75, 1
      colors = c("azure4", "azure4", "azure2", "azure2", "#481567FF", "#2D708EFF", "#3CBB75FF", "#FDE725FF"),
      # the tick marks
      breaks = c(0, as.numeric(thresh.fixed_1), as.numeric(thresh.MTSS), 0.5, 0.75, 1.00),
      # labels for the tick marks
      labels = c("", paste0("minimally suitable", "\n(", round(as.numeric(thresh.fixed_1), 2), ", fixed_1)"), paste0("suitable", "\n(", round(as.numeric(thresh.MTSS), 2), ", MTSS)"), 0.5, 0.75, 1),
      limits = c(0, 1.0),
      guide = guide_colorbar(frame.colour = "black", ticks.colour = "black", barwidth = 20, draw.ulim = TRUE, draw.llim = TRUE)
      )  +
    labs(caption = "Grey areas are unsuitable (below the fixed_1 thresh), white areas are minimally suitable (above the fixed_1 thresh, below the MTSS) and colored areas are suitable (above the MTSS thresh)")
}

```

I also made a duplicate function of the above function called `map_cloglog_output_low_thresh()`, which does not have the label for the `fixed_1` threshold on the colorscale, because these labels would often overlap (code not shown).

```{r mapping helper function- low thresh, eval = TRUE, include = FALSE}

map_cloglog_output_low_thresh <- function(raster.df, raster.value.name, thresh.fixed_1, thresh.MTSS) {
...
regional_ensemble_1995_plot <- map_cloglog_output(
  ...
  thresh.fixed_1 = regional_ensemble_thresholds[1, 4], # the df cell coordinates of the fixed_1 thresh
...
ggsave(
  regional_ensemble_1995_plot,
  filename = file.path(mypath, "slf_regional_ensemble_v3", "plots", "regional_ensemble_pred_suit_globe_1981-2010.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
global_1995_plot <- map_cloglog_output_low_thresh(
  ...
  thresh.fixed_1 = summary_global[18, 2], # the df cell coordinates of the fixed_1 thresh
...
ggsave(
  global_1995_plot,
  filename = file.path(mypath, "slf_global_v5", "plots", "global_pred_suit_globe_1981-2010.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
regional_ensemble_2055_126_plot <- map_cloglog_output(
  ...
  thresh.fixed_1 = regional_ensemble_thresholds[2, 4], # the df cell coordinates of the fixed_1 thresh
...
ggsave(
  ...
  filename = file.path(mypath, "slf_regional_ensemble_v3", "plots", "regional_ensemble_pred_suit_globe_2041-2070_GFDL_ssp126.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
global_2055_126_plot <- map_cloglog_output_low_thresh(
...
ggsave(
  ...
  filename = file.path(mypath, "slf_global_v5", "plots", "global_pred_suit_globe_2041-2070_GFDL_ssp126.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
regional_ensemble_2055_370_plot <- map_cloglog_output(
  ...
  thresh.fixed_1 = regional_ensemble_thresholds[3, 4], # the df cell coordinates of the fixed_1 thresh
...
ggsave(
  ...
  filename = file.path(mypath, "slf_regional_ensemble_v3", "plots", "regional_ensemble_pred_suit_globe_2041-2070_GFDL_ssp370.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
global_2055_370_plot <- map_cloglog_output_low_thresh(
...
ggsave(
  ...
  filename = file.path(mypath, "slf_global_v5", "plots", "global_pred_suit_globe_2041-2070_GFDL_ssp370.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
regional_ensemble_2055_585_plot <- map_cloglog_output(
  ...
  thresh.fixed_1 = regional_ensemble_thresholds[4, 4], # the df cell coordinates of the fixed_1 thresh
...
ggsave(
  ...
  filename = file.path(mypath, "slf_regional_ensemble_v3", "plots", "regional_ensemble_pred_suit_globe_2041-2070_GFDL_ssp585.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
global_2055_585_plot <- map_cloglog_output_low_thresh(
...
ggsave(
  ...
  filename = file.path(mypath, "slf_global_v5", "plots", "global_pred_suit_globe_2041-2070_GFDL_ssp585.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
regional_ensemble_2055_ssp_mean_plot <- map_cloglog_output(
  ...
  thresh.fixed_1 = regional_ensemble_thresholds[5, 4], # the df cell coordinates of the fixed_1 thresh
...
ggsave(
  regional_ensemble_2055_ssp_mean_plot,
  filename = file.path(mypath, "slf_regional_ensemble_v3", "plots", "regional_ensemble_pred_suit_globe_2041-2070_GFDL_ssp_mean.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
global_2055_ssp_mean_plot <- map_cloglog_output_low_thresh(
...
ggsave(
  global_2055_ssp_mean_plot,
  filename = file.path(mypath, "slf_global_v5", "plots", "global_pred_suit_globe_2041-2070_GFDL_ssp_mean.jpg"),
  height = 8,
  width = 12,
  device = jpeg,
  dpi = "retina"
...
regional_ensemble_1995_classified <- terra::classify(
  ...
  filename = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_1981-2010.asc"), # also write to file
  filetype = "AAIGrid",
  overwrite = TRUE
  ) 
...
global_1995_classified <- terra::classify(
  ...
  filename = file.path(mypath, "working_dir", "slf_global_v5_binarized_1981-2010.asc"), 
  filetype = "AAIGrid",
  overwrite = TRUE
  ) 
...
regional_ensemble_1995_classified_df <- terra::rast(
  x = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_1981-2010.asc")
  ) %>%
...
regional_ensemble_2055_126_classified <- terra::classify(
  ...
  right = NA, # close both ends of the range of classification values
  others = strtoi(00000001, base = 2), # make it the unsuitable value if not in this range
  filename = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp126_GFDL.asc"), # also write to file
  filetype = "AAIGrid",
  overwrite = TRUE
  ) 
...
global_2055_126_classified <- terra::classify(
  ...
  right = NA, 
  others = strtoi(00000100, base = 2), 
  filename = file.path(mypath, "working_dir", "slf_global_v5_binarized_2041-2070_ssp126_GFDL.asc"), 
  filetype = "AAIGrid",
  overwrite = TRUE
  ) 
...
regional_ensemble_2055_126_classified_df <- terra::rast(
  x = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp126_GFDL.asc")
  ) %>%
  terra::as.data.frame(., xy = TRUE)
...
ggplot() +
  ...
  labs(
    title = "Binarized suitability for 'regional_ensemble' model",
    subtitle = "projected to 2041-2070 | ssp126 | GFDL-ESM4"
    ) +
  scale_discrete_manual(
    name = "suitability for SLF",
    values = values.obj,
...
regional_ensemble_2055_370_classified <- terra::classify(
  ...
  right = NA, # close both ends of the range of classification values
  others = strtoi(00000001, base = 2), # make it the unsuitable value if not in this range
  filename = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp370_GFDL.asc"), # also write to file
  filetype = "AAIGrid",
  overwrite = TRUE
  ) 
...
global_2055_370_classified <- terra::classify(
  ...
  right = NA, 
  others = strtoi(00000100, base = 2), 
  filename = file.path(mypath, "working_dir", "slf_global_v5_binarized_2041-2070_ssp370_GFDL.asc"), 
  filetype = "AAIGrid",
  overwrite = TRUE
  ) 
...
regional_ensemble_2055_370_classified_df <- terra::rast(
  x = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp370_GFDL.asc")
  ) %>%
  terra::as.data.frame(., xy = TRUE)
...
ggplot() +
  ...
  labs(
    title = "Binarized suitability for 'regional_ensemble' model",
    subtitle = "projected to 2041-2070 | ssp370 | GFDL-ESM4"
    ) +
  scale_discrete_manual(
    name = "suitability for SLF",
    values = values.obj,
...
regional_ensemble_2055_585_classified <- terra::classify(
  ...
  right = NA, # close both ends of the range of classification values
  others = strtoi(00000001, base = 2), # make it the unsuitable value if not in this range
  filename = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp585_GFDL.asc"), # also write to file
  filetype = "AAIGrid",
  overwrite = TRUE
  ) 
...
global_2055_585_classified <- terra::classify(
  ...
  right = NA, 
  others = strtoi(00000100, base = 2), 
  filename = file.path(mypath, "working_dir", "slf_global_v5_binarized_2041-2070_ssp585_GFDL.asc"), 
  filetype = "AAIGrid",
  overwrite = TRUE
  ) 
...
regional_ensemble_2055_585_classified_df <- terra::rast(
  x = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp585_GFDL.asc")
  ) %>%
  terra::as.data.frame(., xy = TRUE)
...
ggplot() +
  ...
  labs(
    title = "Binarized suitability for 'regional_ensemble' model",
    subtitle = "projected to 2041-2070 | ssp585 | GFDL-ESM4"
    ) +
  scale_discrete_manual(
    name = "suitability for SLF",
    values = values.obj,
...
regional_ensemble_2055_ssp_mean_classified <- terra::classify(
  ...
  right = NA, # close both ends of the range of classification values
  others = strtoi(00000001, base = 2), # make it the unsuitable value if not in this range
  filename = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp_mean_GFDL.asc"), # also write to file
  filetype = "AAIGrid",
  overwrite = TRUE
  ) 
...
global_2055_ssp_mean_classified <- terra::classify(
  ...
  right = NA, 
  others = strtoi(00000100, base = 2), 
  filename = file.path(mypath, "working_dir", "slf_global_v5_binarized_2041-2070_ssp_mean_GFDL.asc"), 
  filetype = "AAIGrid",
  overwrite = TRUE
  ) 
...
regional_ensemble_2055_ssp_mean_classified_df <- terra::rast(
  x = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp_mean_GFDL.asc")
  ) %>%
  terra::as.data.frame(., xy = TRUE)
...
ggplot() +
  ...
  labs(
    title = "Binarized suitability for 'regional_ensemble' model",
    subtitle = "projected to 2041-2070 | mean of ssp126, 370, 585 | GFDL-ESM4"
    ) +
  scale_discrete_manual(
    name = "suitability for SLF",
    values = values.obj,
...
global_1995_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_global_v5_binarized_1981-2010.asc"))

regional_ensemble_1995_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_1981-2010.asc"))
...
global_2055_126_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_global_v5_binarized_2041-2070_ssp126_GFDL.asc"))

regional_ensemble_2055_126_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp126_GFDL.asc"))
...
global_2055_370_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_global_v5_binarized_2041-2070_ssp370_GFDL.asc"))

regional_ensemble_2055_370_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp370_GFDL.asc"))
...
global_2055_585_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_global_v5_binarized_2041-2070_ssp585_GFDL.asc"))

regional_ensemble_2055_585_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp585_GFDL.asc"))
...
global_2055_ssp_mean_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_global_v5_binarized_2041-2070_ssp_mean_GFDL.asc"))

regional_ensemble_2055_ssp_mean_classified <- terra::rast(x = file.path(mypath, "working_dir", "slf_regional_ensemble_v3_binarized_2041-2070_ssp_mean_GFDL.asc"))
...
```{r retrieve summary table- area sums, eval = TRUE, warning = FALSE}
...
slf_model_prop_table_1995 <- terra::expanse(
  ...
  unit = "km",
  byValue = TRUE # group by cell value, which is the risk level
) 
...
slf_model_prop_table_joined <- slf_model_prop_table_joined %>%
  ...
  dplyr::rename(
   ...
   "prop_area_future" = "prop_total_area_2055"
  )
...
# change format for LaTeX
slf_model_prop_kable_LX <- knitr::kable(x = slf_model_prop_table_joined, format = "latex", escape = FALSE) %>%
  kableExtra::kable_styling(bootstrap_options = "striped", full_width = TRUE)
# save as LaTeX
kableExtra::save_kable(
  slf_model_prop_kable_LX, 
  file = file.path(here::here(), "vignette-outputs", "figures", "slf_binarized_summed_areas_table.tex"),
  self_contained = TRUE,
  bs_theme = "simplex"
  )
...
```{r terra required classification matrices- range shift, eval = TRUE}
...
slf_binarized_1995_classified <- terra::classify(
  x = slf_binarized_1995, 
  rcl = classes_1995,
  others = NA, # previously others = strtoi(00000001, base = 2),
...
ggplot() +
  ...
  labs(title = "Present suitability for SLF") +
  scale_fill_manual(
    name = "suitability for SLF",
    values = values.obj,
    breaks = breaks.obj,
...
# vector of colors to classify scale
values.obj <- c("azure4", "azure", "darkblue", "darkgreen")
...
table.df.output[2, 1] <- kableExtra::cell_spec(table.df.output[2, 1], format = "html", background = "blue")
...
slf_binarized_2055_126_classified <- terra::classify(
  ...
  rcl = classes_2055, 
  others = NA, # strtoi(00000100, base = 2),
...
```{r retrieve summary table- ssp126 range shift, eval = TRUE, warning = FALSE}
...
# convert to kable
slf_range_shift_126_kable_LX <- knitr::kable(x = slf_range_shift_126_table, format = "latex", escape = FALSE) %>%
  kableExtra::kable_styling(bootstrap_options = "striped", full_width = FALSE)
# save as LaTeX
kableExtra::save_kable(
  slf_range_shift_126_kable_LX, 
  file = file.path(here::here(), "vignette-outputs", "figures", "slf_range_shift_summed_area_table_ssp126_GFDL.tex"),
  self_contained = TRUE,
  bs_theme = "simplex"
  )
...
# convert to kable
slf_range_shift_370_kable_LX <- knitr::kable(x = slf_range_shift_370_table, format = "latex", escape = FALSE) %>%
  kableExtra::kable_styling(bootstrap_options = "striped", full_width = FALSE)
# save as LaTeX
kableExtra::save_kable(
  slf_range_shift_370_kable_LX, 
  file = file.path(here::here(), "vignette-outputs", "figures", "slf_range_shift_summed_area_table_ssp370_GFDL.tex"),
  self_contained = TRUE,
  bs_theme = "simplex"
  )
...
```
I got the following warnings from this code, for some reason:
* "simpleWarning: Point outside of projection domain (GDAL error 1)"
* "simpleWarning: Reprojection failed, err = 2050, further errors will be suppressed on the transform object. (GDAL error 1)"
...
# convert to kable
slf_range_shift_585_kable_LX <- knitr::kable(x = slf_range_shift_585_table, format = "latex", escape = FALSE) %>%
  kableExtra::kable_styling(bootstrap_options = "striped", full_width = FALSE)
# save as latex
kableExtra::save_kable(
  slf_range_shift_585_kable_LX, 
  file = file.path(here::here(), "vignette-outputs", "figures", "slf_range_shift_summed_area_table_ssp585_GFDL.tex"),
  self_contained = TRUE,
  bs_theme = "simplex"
)
...
```{r retrieve summary table- ssp mean range shift, eval = TRUE, warning = FALSE}
...
```{r format range shift table and kable- range shift ssp mean, eval = TRUE}
...
slf_range_shift_ssp_mean_kable_LX <- knitr::kable(x = slf_range_shift_ssp_mean_table, format = "latex", escape = FALSE) %>%
  kableExtra::kable_styling(bootstrap_options = "striped", full_width = FALSE)
# save as laxex
kableExtra::save_kable(
  slf_range_shift_ssp_mean_kable_LX, 
  file = file.path(here::here(), "vignette-outputs", "figures", "slf_range_shift_summed_area_table_ssp_mean_GFDL.tex"),
  self_contained = TRUE,
  bs_theme = "simplex"
  )
...
Here are some plots I created specifically for the publication.
...
# project to new CRS
global_countries <- sf::st_transform(global_countries, crs = "ESRI:54017")
