...
```{r import raster files and save to new location for create_risk_report function}
...
Finally, we have `map.style`, which is a purely aesthetic argument. It should be specified as a list argument (the default is shown below). Again, this does not need to be specified.
