...
```{r generate a report for France, message = FALSE, results = "hide", warning = FALSE}
...
scari::create_risk_report(
  ...
  # aesthetics for plots/tables- dont necessarily need to be specified
  ...
  crs = "ESRI:54017" # the name of the crs used for the input data
)
...
```{r generate a report for French region of Burgundy, message = FALSE, results = "hide", warning = FALSE}

scari::create_risk_report(
  locality.iso = "fra", 
  locality.iso.2 = "FR-BFC", # the ISO-3166-2 for the state or province
  locality.name = "Burgundy-Franche-Comté", 
