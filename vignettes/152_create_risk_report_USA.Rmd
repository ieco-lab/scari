---
title: "Create risk reports for the USA nationally and per state"
...
USA_current <- united_states_L_delicatula_risk_report[["risk_maps"]][["present_risk_map"]] +
  xlim(-12060785.031362064, -6271608.216308273) + # the boundaries in UTM
  ylim(3091555.5611515422, 5614050.1030608015)

USA_future <- united_states_L_delicatula_risk_report[["risk_maps"]][["future_risk_map"]] +
  xlim(-12060785.031362064, -6271608.216308273) +
  ylim(3091555.5611515422, 5614050.1030608015)

USA_shift <- united_states_L_delicatula_risk_report[["range_shift_map"]] +
  xlim(-12060785.031362064, -6271608.216308273) +
  ylim(3091555.5611515422, 5614050.1030608015)
...
readr::write_rds(united_states_L_delicatula_risk_report, file = file.path(here::here(), "vignette-outputs", "reports", "United States", "united_states_L_delicatula_risk_report.rds"))
...
scari::create_risk_report(
  locality.iso = "usa",
  locality.iso.2 = "US-CA",
  locality.name = "california",
  locality.type = "state_province",
  mypath = file.path(here::here(), "vignette-outputs", "reports", "United States", "California"),
  create.dir = TRUE,
  save.report = TRUE,
  buffer.dist = 20000
)
...
scari::create_risk_report(
  locality.iso = "usa",
  locality.iso.2 = "US-PA",
  locality.name = "pennsylvania",
  locality.type = "state_province",
  mypath = file.path(here::here(), "vignette-outputs", "reports", "United States", "Pennsylvania"),
  create.dir = TRUE,
  save.report = TRUE,
  buffer.dist = 20000
)
...
scari::create_risk_report(
  locality.iso = "usa",
  locality.iso.2 = "US-MI",
  locality.name = "michigan",
  locality.type = "state_province",
  mypath = file.path(here::here(), "vignette-outputs", "reports", "United States", "Michigan"),
  create.dir = TRUE,
  save.report = TRUE,
  buffer.dist = 20000
)
...
scari::create_risk_report(
  locality.iso = "usa",
  locality.iso.2 = "US-OR",
  locality.name = "oregon",
  locality.type = "state_province",
  mypath = file.path(here::here(), "vignette-outputs", "reports", "United States", "Oregon"),
  create.dir = TRUE,
  save.report = TRUE,
  buffer.dist = 20000
)
...
scari::create_risk_report(
  locality.iso = "usa",
  locality.iso.2 = "US-WA",
  locality.name = "washington",
  locality.type = "state_province",
  mypath = file.path(here::here(), "vignette-outputs", "reports", "United States", "Washington"),
  create.dir = TRUE,
  save.report = TRUE,
  buffer.dist = 20000
)
...
oregon_risk_plot <- oregon_L_delicatula_risk_report[["viticultural_risk_plot"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
michigan_risk_plot <- michigan_L_delicatula_risk_report[["viticultural_risk_plot"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
washington_risk_map <- washington_L_delicatula_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
oregon_risk_map <-  oregon_L_delicatula_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
michigan_risk_map <- michigan_L_delicatula_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
USA_risk_map_present <- united_states_L_delicatula_risk_report[["risk_maps"]][["present_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
USA_risk_map_future <- united_states_L_delicatula_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
WA_risk_map_present <-  washington_L_delicatula_risk_report[["risk_maps"]][["present_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
...
WA_risk_map_future <-  washington_L_delicatula_risk_report[["risk_maps"]][["future_risk_map"]] +
  theme(
    plot.title = element_blank(),
    plot.subtitle = element_blank(),
    plot.caption = element_blank(),
