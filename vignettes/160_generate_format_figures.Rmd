...
```{r split into segments for geocoding}

slf_populations_latlon_200 <- dplyr::slice_head(slf_populations_latlon, n = 200) 
slf_populations_latlon_400 <- dplyr::slice(slf_populations_latlon, 201:400) 
slf_populations_latlon_600 <- dplyr::slice(slf_populations_latlon, 401:600)
slf_populations_latlon_800 <- dplyr::slice(slf_populations_latlon, 601:800)
slf_populations_latlon_1000 <- dplyr::slice(slf_populations_latlon, 801:1000)
slf_populations_latlon_1200 <- dplyr::slice(slf_populations_latlon, 1001:1200)
slf_populations_latlon_tail <- dplyr::slice(slf_populations_latlon, 1201:1282)
...
# geocode
slf_populations_geocoded_200 <- tidygeocoder::reverse_geocode(
  .tbl = slf_populations_latlon_200, 
  lat = y, 
  long = x, 
...
slf_populations_geocoded_400 <- tidygeocoder::reverse_geocode(
  .tbl = slf_populations_latlon_400, 
  lat = y, 
  long = x, 
  full_results = TRUE, # give each element of the address in a column
  method = "arcgis",
...
slf_populations_geocoded_600 <- tidygeocoder::reverse_geocode(
  .tbl = slf_populations_latlon_600, 
  lat = y, 
  long = x, 
  full_results = TRUE, # give each element of the address in a column
  method = "arcgis",
...
slf_populations_geocoded_800 <- tidygeocoder::reverse_geocode(
  .tbl = slf_populations_latlon_800, 
  lat = y, 
  long = x, 
  full_results = TRUE, # give each element of the address in a column
  method = "arcgis",
...
slf_populations_geocoded_1000 <- tidygeocoder::reverse_geocode(
  .tbl = slf_populations_latlon_1000, 
  lat = y, 
  long = x, 
  full_results = TRUE, # give each element of the address in a column
  method = "arcgis",
...
slf_populations_geocoded_1200 <- tidygeocoder::reverse_geocode(
  .tbl = slf_populations_latlon_1200, 
  lat = y, 
  long = x, 
  full_results = TRUE, # give each element of the address in a column
  method = "arcgis",
...
slf_populations_geocoded_tail <- tidygeocoder::reverse_geocode(
  .tbl = slf_populations_latlon_tail, 
  lat = y, 
  long = x, 
  full_results = TRUE, # give each element of the address in a column
  method = "arcgis",
...
slf_populations_geocoded <- rbind(
  slf_populations_geocoded_200,
  slf_populations_geocoded_400,
  slf_populations_geocoded_600,
  slf_populations_geocoded_800,
  slf_populations_geocoded_1000,
  slf_populations_geocoded_1200,
  slf_populations_geocoded_tail
)
