...
write_csv(
  ...
  file = file.path(mypath, "slf_global_v4", "global_slf_all_coords_2041-2070_GFDL_ssp_mean_xy_pred_suit_clamped_cloglog_mean.csv")
    )
...
write_csv(
  ...
  file = file.path(mypath, "slf_regional_ensemble_v2", "regional_ensemble_wineries_2041-2070_GFDL_ssp_mean_xy_pred_suit.csv")
  )
